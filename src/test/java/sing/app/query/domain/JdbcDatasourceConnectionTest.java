...
class JdbcDatasourceConnectionTest {
    ...
    void testExecuteReturnsQueryResults() {
        ...
        List<Map<String, Object>> result = connection.execute(query, null, null, null, null);
    ...
    void testExecuteThrowsException() {
        ...
        RuntimeException thrown = assertThrows(RuntimeException.class, () -> connection.execute(query, null, null, null, null));
